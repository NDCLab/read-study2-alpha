...
if laplacian:
    ...
    path_to_mat = glob(f"{analysis_path}/derivatives/erp/read_flanker_woody_corrected_Resp_erps_min_6t_06_05_2026_15_21_52.mat")[0] #latest file; computed on "checked" data
...
if laplacian:
    ...
    output_data.to_csv(f"{analysis_path}/derivatives/csv/{session}/read_erp_woody_filtered.csv", index=False)
