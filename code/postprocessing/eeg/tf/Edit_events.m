...
for t=1:length(EEG.event)
    ...
    social = {EEG.event.observation}
    
    % Selecting specific variables for this trial
    vars_to_join = {eventType{t}, social{t}, num2str(congruency{t}), num2str(accuracy{t})};
