...
data_location = '/home/cknowlto/my_lab_shortcut/analyses/read-study2-alpha/derivatives/tf';
...
save_location = '/home/cknowlto/my_lab_shortcut/analyses/read-study2-alpha/derivatives/tf/dataset';
...
Conds = {'resp_s_i_0','resp_s_i_1', 'resp_ns_i_1', 'stim_ns_i_0'}; %leave blank if resting data

% 6. Name of Conditions to be used for plotting - this such make the order
% that the conditions are named above
ConditionNames = {'Incongruent Social Error' 'Incongruent Social Correct' 'Incongruent Alone Correct' 'Incongruent Alone Error'}; %If resting, just put one condition name here (e.g., Resting)
